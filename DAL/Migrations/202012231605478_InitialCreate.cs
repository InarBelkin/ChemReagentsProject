    ...
    public partial class InitialCreate : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.Concentrations", t => t.ConcentracionId, cascadeDelete: true)
                .Index(t => t.ReagentId)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Concentrations", "SolutionRecipeId", "dbo.Solution_recipe");
            DropForeignKey("dbo.Solution_recipe_line", "ConcentracionId", "dbo.Concentrations");
            ...
            DropIndex("dbo.Concentrations", new[] { "SolutionRecipeId" });
